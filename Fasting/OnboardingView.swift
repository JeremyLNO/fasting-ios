...
struct OnboardingView: View {
    ...
    // (The "free / Crazy Bee Labs commitment" page lives in its own `CommitmentView`, shown once
    // before onboarding — same pattern as the other free Crazy Bee Labs apps.)
